...
mkdir -p build/asan
INC="-Isrc/core -Isrc/stdlib -Isrc/vm -Isrc/compiler -Isrc/utils -Isrc/wasm -Isrc/bin -Iquickjs -Ipcre2"
...
"$GCC" $FLAGS -o build/lxclua_asan.exe build/asan/*_as.o \
  ...
  wasmtime/wasmtime-v48.0.1-x86_64-mingw-c-api/lib/libwasmtime.a \
