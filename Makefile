...
mingw:
	...
	"SYSCFLAGS=-DLUA_BUILD_AS_DLL -DLUA_USE_DLOPEN -DLUA_COMPAT_MATHLIB -DLUA_COMPAT_MAXN -DLUA_COMPAT_MODULE" "SYSLIBS=-lwininet -lws2_32 $(MYLIBS)" "SYSLDFLAGS=-s" \
...
mingw-static:
	...
	"AR=$(AR)" "RANLIB=$(RANLIB)" \
	"SYSCFLAGS=-DLUA_USE_DLOPEN -DLUA_COMPAT_MATHLIB -DLUA_COMPAT_MAXN -DLUA_COMPAT_MODULE" "SYSLIBS=-lwininet -lws2_32 $(MYLIBS)" "SYSLDFLAGS=-s" \
	"MYOBJS=$(MYOBJS)" lxclua.exe
