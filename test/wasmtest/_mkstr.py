...
'''
open('_str.wat', 'w', encoding='utf-8').write(wat)
r1 = subprocess.run([wt, 'parse', '_str.wat', '-o', '_str.wasm'], capture_output=True, text=True)
print('parse:', r1.returncode, (r1.stderr or '')[:200])
if r1.returncode == 0:
    r2 = subprocess.run([wt, 'validate', '_str.wasm'], capture_output=True, text=True)
