...
enum RESERVED {
  ...
  TK_GLOBAL, TK_GOTO, TK_IF, TK_IN, TK_TYPE_INT, TK_IS, TK_KEYWORD, TK_LAMBDA, TK_LOCAL, TK_LONG, TK_MATCH, TK_NAMESPACE, TK_NIL, TK_NOT, TK_OPERATOR, TK_OR,
  TK_REPEAT, TK_REQUIRES,
  TK_RETURN, TK_STRUCT, TK_SUPERSTRUCT, TK_SWITCH, TK_TAKE, TK_THEN, TK_TRUE, TK_TRY, TK_UNTIL, TK_USING, TK_VOID, TK_WHEN, TK_WHILE, TK_WITH,
