...
static void PrintCode(const Proto* f) {
    ...
    int line = luaG_getfuncline(f, pc);
        ...
        case OP_JMP:        printf("%d", sj); printf(COMMENT "to %d", sj + pc + 2); break;
        case OP_EQ:         printf("%d %d %d", a, b, c); printf(COMMENT "%s k=%d", (a ? "true->skip" : "false->skip"), k); break;
        case OP_LT:         printf("%d %d %d", a, b, c); printf(COMMENT "%s k=%d", (a ? "true->skip" : "false->skip"), k); break;
        case OP_LE:         printf("%d %d %d", a, b, c); printf(COMMENT "%s k=%d", (a ? "true->skip" : "false->skip"), k); break;
        case OP_EQK:        printf("%d %d %d", a, b, c); printf(COMMENT "%s k=%d ; ", (a ? "true->skip" : "false->skip"), k); PrintConstant(f, c); break;
        case OP_EQI:        printf("%d %d %d", a, b, c); printf(COMMENT "%s k=%d raw=0x%016llx sB=%d", (a ? "true->skip" : "false->skip"), k, (unsigned long long)i, b - OFFSET_sC); break;
        case OP_LTI:        printf("%d %d %d", a, b, c); printf(COMMENT "%s k=%d", (a ? "true->skip" : "false->skip"), k); break;
        case OP_LEI:        printf("%d %d %d", a, b, c); printf(COMMENT "%s k=%d", (a ? "true->skip" : "false->skip"), k); break;
        case OP_GTI:        printf("%d %d %d", a, b, c); printf(COMMENT "%s k=%d", (a ? "true->skip" : "false->skip"), k); break;
        case OP_GEI:        printf("%d %d %d", a, b, c); printf(COMMENT "%s k=%d", (a ? "true->skip" : "false->skip"), k); break;
        case OP_TEST:       printf("%d %d", a, c); printf(COMMENT "%s k=%d", (a ? "true->skip" : "false->skip"), k); break;
        case OP_TESTSET:    printf("%d %d %d", a, b, c); printf(COMMENT "%s k=%d", (a ? "true->skip" : "false->skip"), k); break;
        ...
        case OP_FORLOOP:    printf("%d %d", a, bx); printf(COMMENT "to %d", pc - bx + 2); break;
        case OP_FORPREP:    printf("%d %d", a, bx); printf(COMMENT "exit to %d", pc + bx + 3); break;
        case OP_TFORPREP:   printf("%d %d", a, bx); printf(COMMENT "to %d", pc + bx + 2); break;
        case OP_TFORCALL:   printf("%d %d", a, c); break;
        case OP_TFORLOOP:   printf("%d %d", a, bx); printf(COMMENT "to %d", pc - bx + 2); break;
