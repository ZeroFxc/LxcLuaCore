...
enum RESERVED {
  ...
  TK_AND = FIRST_RESERVED, TK_ASM, TK_ASYNC, TK_AWAIT, TK_BOOL, TK_BREAK, TK_CASE, TK_CATCH, TK_CHAR, TK_COMMAND, TK_CONCEPT, TK_CONST, TK_CONTINUE, TK_DEFAULT, TK_DEFER, TK_DELETE, TK_DO, TK_DOUBLE, TK_ELSE, TK_ELSEIF, TK_END, TK_ENUM, TK_EXPORT, TK_FALSE, TK_FINALLY, TK_TYPE_FLOAT, TK_FOR, TK_FUNCTION,
