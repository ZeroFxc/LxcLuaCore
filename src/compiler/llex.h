...
enum RESERVED {
  ...
  TK_AND = FIRST_RESERVED, TK_ASM, TK_ASTPARSER, TK_ASYNC, TK_AWAIT, TK_BOOL, TK_BREAK, TK_CASE, TK_CATCH, TK_CHAR, TK_COMMAND, TK_CONCEPT, TK_CONST, TK_CONTINUE, TK_DEFAULT, TK_DEFER, TK_DELETE, TK_DO, TK_DOUBLE, TK_ELSE, TK_ELSEIF, TK_END, TK_ENUM, TK_EXPORT, TK_FALSE, TK_FINALLY, TK_TYPE_FLOAT, TK_FOR, TK_FUNCTION,
  TK_GLOBAL, TK_GUARD, TK_GOTO, TK_IF, TK_IN, TK_TYPE_INT, TK_IS, TK_INSTANCEOF, TK_KEYWORD, TK_LAMBDA, TK_LOCAL, TK_LONG, TK_NAMESPACE, TK_NIL, TK_NOT, TK_OPERATOR, TK_OR,
...
typedef struct Token {
  ...
  int nospace;  /**< 与前一个 token 之间没有空白字符（用于区分 .. 拼接和范围操作符） */
} Token;
