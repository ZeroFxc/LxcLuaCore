...
static LspKeyword lsp_keywords[] = {
    {"abstract",  TOK_ABSTRACT},  {"and",       TOK_AND},
    {"array",     TOK_ARRAY},     {"asm",       TOK_ASM},
    ...
    {"defer",     TOK_DEFER},     {"delete",    TOK_DELETE},
    {"do",        TOK_DO},
    {"double",    TOK_DOUBLE},    {"else",      TOK_ELSE},
    {"elseif",    TOK_ELSEIF},    {"end",       TOK_END},
    {"enum",      TOK_ENUM},      {"export",    TOK_EXPORT},
    {"false",     TOK_FALSE},     {"final",     TOK_FINAL},
    {"finally",   TOK_FINALLY},
    {"float",     TOK_TYPE_FLOAT},     {"for",       TOK_FOR},
    {"function",  TOK_FUNCTION},  {"get",       TOK_GET},
    {"global",    TOK_GLOBAL},
    {"guard",     TOK_GUARD},     {"goto",      TOK_GOTO},
    {"if",        TOK_IF},
    {"in",        TOK_IN},        {"int",       TOK_TYPE_INT},
    {"extends",   TOK_EXTENDS},   {"implements",TOK_IMPLEMENTS},
    {"interface", TOK_INTERFACE}, {"is",        TOK_IS},
    {"instanceof",TOK_INSTANCEOF},{"keyword",   TOK_KEYWORD},
    {"lambda",    TOK_LAMBDA},    {"local",     TOK_LOCAL},
    {"long",      TOK_LONG},      {"match",     TOK_MATCH},
    {"namespace", TOK_NAMESPACE}, {"new",       TOK_NEW},
    {"nil",       TOK_NIL},       {"not",       TOK_NOT},
    {"operator",  TOK_OPERATOR},  {"or",        TOK_OR},
    {"private",   TOK_PRIVATE},   {"protected", TOK_PROTECTED},
    {"public",    TOK_PUBLIC},    {"repeat",    TOK_REPEAT},    {"requires",  TOK_REQUIRES},
    {"return",    TOK_RETURN},    {"sealed",    TOK_SEALED},
    {"set",       TOK_SET},       {"struct",    TOK_STRUCT},
    {"super",     TOK_SUPER},     {"superstruct",TOK_SUPERSTRUCT},
    {"static",    TOK_STATIC},    {"switch",    TOK_SWITCH},    {"take",      TOK_TAKE},
    {"then",      TOK_THEN},      {"trait",     TOK_TRAIT},
    {"true",      TOK_TRUE},
    {"try",       TOK_TRY},       {"until",     TOK_UNTIL},
    {"use",       TOK_USE},       {"using",     TOK_USING},     {"void",      TOK_VOID},
