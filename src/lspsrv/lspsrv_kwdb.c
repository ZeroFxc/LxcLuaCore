...
static LspKeywordEntry lua_keywords[] = {
    ...
    {"abstract",  COMPLETION_KEYWORD, "Keyword (LXCLUA)", "Declare an abstract class or method"},
    {"array",     COMPLETION_KEYWORD, "Type (LXCLUA)",    "Array type annotation"},
    ...
    {"delete",    COMPLETION_KEYWORD, "Keyword (LXCLUA)", "Delete a key from a table"},
    ...
    {"extends",   COMPLETION_KEYWORD, "Keyword (LXCLUA)", "Specify parent class in inheritance"},
    {"final",     COMPLETION_KEYWORD, "Keyword (LXCLUA)", "Declare a final class or method"},
    ...
    {"get",       COMPLETION_KEYWORD, "Keyword (LXCLUA)", "Define a getter property accessor"},
    {"guard",     COMPLETION_KEYWORD, "Keyword (LXCLUA)", "Guard statement: early exit if condition fails"},
    {"implements",COMPLETION_KEYWORD, "Keyword (LXCLUA)", "Implement interfaces in class definition"},
    {"instanceof",COMPLETION_OPERATOR, "Operator (LXCLUA)", "Check object instance of class"},
    {"interface", COMPLETION_KEYWORD, "Keyword (LXCLUA)", "Define an interface type"},
    ...
    {"match",     COMPLETION_KEYWORD, "Keyword (LXCLUA)", "Pattern matching: match expr { case pat => val, ... } end"},
    {"namespace", COMPLETION_KEYWORD, "Keyword (LXCLUA)", "Define a namespace"},
    {"new",       COMPLETION_KEYWORD, "Keyword (LXCLUA)", "Create a new instance of a class"},
    {"private",   COMPLETION_KEYWORD, "Keyword (LXCLUA)", "Private access modifier"},
    {"protected", COMPLETION_KEYWORD, "Keyword (LXCLUA)", "Protected access modifier"},
    {"public",    COMPLETION_KEYWORD, "Keyword (LXCLUA)", "Public access modifier"},
    ...
    {"trait",     COMPLETION_KEYWORD, "Keyword (LXCLUA)", "Define a trait type"},
    {"try",       COMPLETION_KEYWORD, "Keyword (LXCLUA)", "Try-catch-finally statement"},
    {"use",       COMPLETION_KEYWORD, "Keyword (LXCLUA)", "Import trait implementations"},
...
static LspKeywordEntry lua_snippets[] = {
    ...
    {"ifeif", COMPLETION_SNIPPET, "Snippet", "If-elseif-else statement",
     "if ${1:cond1} then\n\t${2:body1}\nelseif ${3:cond2} then\n\t${4:body2}\nelse\n\t${0:else_body}\nend"},
    {"guard", COMPLETION_SNIPPET, "Snippet", "Guard statement",
    ...
    {"switch", COMPLETION_SNIPPET, "Snippet", "LXCLUA switch statement",
     "switch ${1:expr}\n\tcase ${2:value1}:\n\t\t${3:body1}\n\tcase ${4:value2}:\n\t\t${5:body2}\n\tdefault:\n\t\t${0:default_body}\nend"},
    {"match", COMPLETION_SNIPPET, "Snippet", "LXCLUA match pattern matching",
     "match ${1:expr} do\n\tcase ${2:pattern} => ${3:result}\n\tcase ${4:pattern2} => ${5:result2}\n\tcase _ => ${0:default_result}\nend"},
